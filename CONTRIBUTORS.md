...
- [@bhaskoro-muthohar](https://github.com/bhaskoro-muthohar) — MCP tool results analysis (#46, #50), message structure validation (#60), tool_reference support (#90), and ongoing project support
